    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between p-10 gradient-brand text-white relative overflow-hidden">
        ...
        <div className="relative">
          <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-4xl font-display font-bold leading-tight">
            One campus.<br />One network.<br />Every opportunity.
          </motion.h2>
          <p className="mt-4 text-white/80 max-w-md">Join 10,000+ students, alumni, and faculty already building their futures together.</p>
        </div>
