...
export default function Resources() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Resources"
        description="Curated by seniors, alumni, and placement office."
      />
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {sections.map((s) => (
          <Card key={s.title} className="p-5">
            <div
              className={`size-11 rounded-xl bg-${s.color}/10 text-${s.color} grid place-items-center mb-3`}
            >
      ...
      <div>
        ...
        <div className="space-y-2">
          {[
            "System Design cheat sheet — v2",
            "Frontend hiring roadmap 2026",
            "OpenAI take-home tips (unofficial)",
            "Product management case studies pack",
          ].map((t) => (
