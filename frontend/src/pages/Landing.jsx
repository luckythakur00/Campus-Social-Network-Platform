...
const features = [
  {
    ...
    body: "Students, alumni, faculty, and recruiters in one place.",
  },
  {
    icon: Briefcase,
    title: "Curated Jobs",
    body: "Handpicked roles and warm referrals from alumni.",
  },
  {
    icon: GraduationCap,
    title: "1:1 Mentorship",
    body: "Book sessions with mentors across FAANG, startups, research.",
  },
  {
    icon: MessageSquare,
    title: "Realtime Chat",
    body: "Discord-style channels, DMs, and voice notes.",
  },
  {
    icon: Calendar,
    title: "Events & RSVPs",
    body: "Hackathons, alumni meets, career fairs — all in one calendar.",
  },
  {
    icon: Sparkles,
    title: "Smart Feed",
    body: "Personalized posts, jobs, and opportunities that matter.",
  },
];
...
const testimonials = [
  {
    ...
    body: "I got my Google internship through a warm referral I found on Campus Connect. The mentorship sessions were a game-changer.",
  },
  {
    name: "Rohan V.",
    role: "SDE-2 @ Stripe · Alumni",
    body: "Giving back to campus is now effortless. I post one referral and meet 20 great candidates.",
  },
  {
    name: "Dr. Kavita R.",
    role: "Faculty · ML",
    body: "The best way I've found to stay connected with my past students and share opportunities with current ones.",
  },
];
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 md:py-28 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-lg">
              A modern social platform built for universities. Feeds, jobs, referrals, mentorship,
              events — everything students and alumni need in one place.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button
                size="lg"
                asChild
                className="gradient-brand text-white border-0 hover:opacity-90 shadow-[var(--shadow-glow)]"
              >
                <Link to="/register">
          ...
          >
            ...
            <Card className="p-6 shadow-2xl">
              ...
              <p className="mt-4 text-sm">
                Hiring 3 senior designers at Figma. Happy to refer strong candidates from campus 💫
              </p>
            ...
            <Card className="p-4 mt-4 ml-8 shadow-xl">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                "Loved your capstone demo — let's chat!"
              </p>
            </Card>
          </motion.div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-3 text-muted-foreground">
            One product replacing 10 group chats, spreadsheets, and lost email threads.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 opacity-70">
          {[
            ...
            <span key={p} className="font-display font-semibold text-lg text-muted-foreground">
              {p}
            </span>
          ))}
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-3 text-muted-foreground">
            Free for students & alumni. Institutions pay per seat.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-4">
          {[
            {
              name: "Student",
              price: "Free",
              features: ["Full feed & messaging", "Apply to jobs & referrals", "Book mentorship"],
            },
            {
              name: "Pro",
              price: "₹299/mo",
            ...
            <Card
              key={p.name}
              className={`p-6 ${p.popular ? "border-primary shadow-[var(--shadow-glow)]" : ""}`}
            >
      ...
      <section className="max-w-3xl mx-auto px-4 py-20">
        ...
        <div className="space-y-3">
          {[
            {
              q: "Is Campus Connect free for students?",
              a: "Yes — every student and alumnus gets full access. Institutions pay per seat for admin & analytics.",
            },
            {
              q: "How is this different from LinkedIn?",
              a: "It's built around your specific campus — verified members only, warm referrals, mentorship booking, and student-first UX.",
            },
            {
              q: "Can faculty post announcements?",
              a: "Yes. Faculty accounts can broadcast announcements to their courses and manage communities.",
            },
            {
              q: "Do you support single sign-on?",
              a: "Yes, via SAML/Google Workspace for institutional plans.",
            },
          ].map((f) => (
