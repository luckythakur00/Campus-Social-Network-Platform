...
export default function Referrals() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Referrals"
        description="Warm intros from alumni currently working at these companies."
        action={<Button className="gradient-brand text-white border-0">Post a referral</Button>}
      />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">
                      Referred by <span className="font-medium text-foreground">{poster.name}</span>
                    </span>
