    ...
    <div className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <Card className="p-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">{poster.headline}</p>
            </div>
          </div>
        ...
        <Card className="p-5">
          ...
          <Button
            className="w-full mt-3 gradient-brand text-white border-0"
            onClick={() => toast.success("Referral requested!")}
          >
        ...
        <ol className="space-y-4">
          {timeline.map((t, i) => (
            <li key={i} className="flex items-start gap-3">
              <div
                className={`size-8 rounded-full grid place-items-center shrink-0 ${t.done ? "bg-success text-success-foreground" : "bg-muted"}`}
              >
